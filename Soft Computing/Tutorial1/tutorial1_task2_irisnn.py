...
dataset_init = rc('Iris.csv', names=['SepalLengthCm','SepalWidthCm','PetalLengthCm','PetalWidthCm','Species'])

dataset=dataset_init.values
X=dataset[:,0:4] #Attributes for each data entry
Y=dataset[:,4] #True outputs - the correct output ( Correct Iris Species )

# Multilayer Perceptron Neural Network
# Classification between 0, 1, 2 linking to the three Iris species: Setosa, Veriscolor and Virginica
# This code is classifying the whole dataset and then using the original training to provide a predication on the original dataset
...
#Splitting data into train and validation data sets
